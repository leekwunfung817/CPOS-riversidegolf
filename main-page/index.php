...
<!-- 
    ...
    <nav class="navbar navbar-expand-lg bg-white navbar-light sticky-top p-0" style="z-index: 1;">
        ...
        <!-- <a class="navbar-brand d-flex align-items-center px-4 px-lg-5">
            <h2 class="m-0 text-primary">白石高球練習場<br>Riverside Whitehead Golf Club</h2>
        </a> -->
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav ms-auto p-4 p-lg-0">
                <!-- <a href="index.html" class="nav-item nav-link active">首頁<br>Home</a> -->
                <!-- <a href="../configuration-bookers.php" class="nav-item nav-link">更改停車八達通<br>Change Car Parking Octopus</a> -->
                ...
                <div class="nav-item dropdown">
                    <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">行政<br>Management</a>
                    <div class="dropdown-menu fade-up m-0">
                        <a href="../configuration-administraion.php" class="dropdown-item">更改廣播訊息<br>Change Broadcasting Message</a>
                        <a href="../configuration-administraion.php" class="dropdown-item">更改支付設定<br>Change Payment Setting</a> -->
                        <!-- <a href="../booking-records.php" class="dropdown-item">閱覽尚未預訂的打球道<br>Unbooked Fairway</a> -->
<!-- 
...
<!-- 
                ...
                <a href="service.html" class="nav-item nav-link">更改停車八達通<br>Change Car Parking Octopus</a>
    ...
    <div class="container-fluid p-0 pb-5">
        <div class="owl-carousel header-carousel position-relative">
            <div class="owl-carousel-item position-relative">
                ...
                <!-- <img class="img-fluid" src="img/9762_P_1434441995978.jpg" alt=""> -->
                    ...
                    <div class="container">
                        <div class="row justify-content-center">
                            <div class="col-12 col-lg-8 text-center">
                                ...
                                <a href="../terms_booking.php" class="btn btn-primary py-md-3 px-md-5 me-3 animated slideInLeft">打球道預訂<br>Fairway Booking</a>
                                <!-- <a href="../booking-records.php" class="btn btn-light py-md-3 px-md-5 animated slideInRight">閱覽尚未預訂的打球道<br>Unbooked Fairway</a> -->
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="owl-carousel-item position-relative">
                ...
                <div class="position-absolute top-0 start-0 w-100 h-100 d-flex align-items-center" style="background: rgba(53, 53, 53, .7);">
                    <div class="container">
                        <div class="row justify-content-center">
                            <div class="col-12 col-lg-8 text-center">
                                <h5 class="text-white text-uppercase mb-3 animated slideInDown">歡迎來到 白石高爾夫球練習場</h5>
        ...
        <div class="container">
            <div class="copyright">
                <div class="row">
                    ...
                    <!-- 
                    <div class="col-md-6 text-center text-md-end">
                        Designed By <a class="border-bottom">CPOS Technology Limited</a>
                    </div> -->
                </div>
            </div>
        </div>
